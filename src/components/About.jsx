  ...
  return (
    <section id="about" className='px-8 py-24 flex flex-col gap-6 max-w-[1000px] mx-auto'>
      ...
      <div className='text-center text-lg text-zinc-600'>
        <p>As a internship Full-Stack Developer, I possess an impressive arsenal of front-end skills in HTML, CSS, JavaScript, React and TailwindCSS. As a back-end developer, I have a solid knowledge of Java, Python, PostgreSQL and Firebase.</p>
