  ...
  return (
    <section id="hero" className='hero-container'>
      ...
      <div className='center-container'>
        <h1 className='hero-title'>Full-Stack Java/React Developer 🌊</h1>
        <p className='paragraph max-w-[500px]'>Hi I'm João Victor. A passionate Full-stack Java/React Developer based in São Paulo, Brazil. 📍</p>
